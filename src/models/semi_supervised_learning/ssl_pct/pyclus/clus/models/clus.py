...
class ClusModel(PredictiveModel):
    ...
    def perform_experiment(
        ...
        # print(cmd_directives)
        # print("-ssl" in cmd_directives)
        # print(is_fit)
        if not is_fit and "-ssl" in cmd_directives:
            cmd_directives = cmd_directives.replace("-ssl","")
        if cmd_directives:
            cmd_directives += " "
        #  TRY TO DROP -SSL HERE WHEN PREDICT
