...
create_directories(folder_path, ['r2', 'mse', 'mae', 'ca', 'arrmse','preds'])
...
for i in range(Method.iterations):
    ...
    plot_and_save_figures(proposed_method_instance.epochs, 
                          [proposed_method_instance.instance_aRRMSE[i,:-1], upperbound_method.upperbound_aRRMSE[i,:-1], lowerbound_method.random_aRRMSE[i,:-1], baseline_method.baseline_aRRMSE[i,:-1], qbcrf_method.qbcrf_aRRMSE[i,:-1]], 
                          ['Instance based QBC', 'Upper bound', 'Random sampling', 'Greedy sampling', 'QBC-RF'], 
...
plot_and_save_figures(proposed_method_instance.epochs, 
                      [instance_mean_ARRMSE[:-1], upperbound_mean_ARRMSE[:-1], random_mean_ARRMSE[:-1], greedy_mean_ARRMSE[:-1], qbcrf_mean_ARRMSE[:-1]], 
                      ['Instance based QBC', 'Upper bound', 'Random sampling', 'Greedy sampling', 'QBC-RF'], 
